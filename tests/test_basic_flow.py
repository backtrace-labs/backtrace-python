...
def check_basic_report(obj):
    ...
    assert obj['sourceCode'][source_code_id]['path'].endswith(os.path.join(tests_dir, "exe", "simple_report.py"))
...
def check_multi_file(obj): 
    ...
    assert obj['sourceCode'][source_code_id]['path'].endswith(os.path.join(tests_dir, "exe", "multi_file.py"))
